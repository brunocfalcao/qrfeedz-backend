    ...
    <main class="grid w-full grow grid-cols-1 place-items-center">
        <div class="w-full max-w-[26rem] p-4 sm:px-5">
            <div class="text-center">
                <img class="mx-auto h-16 w-16 " src="{{ asset('vendor/qrfeedz-backend/images/logo-primary.png') }}" alt="logo" />
                <div class="mt-4">
            ...
            <div class="card mt-5 rounded-lg p-5 lg:p-7">
                <label class="relative flex">
                    <input id="newPassword"
                        ...
                        placeholder="Write your new password" type="text" />
                    <span
            ...
            <div class="mt-4 text-center text-xs+">
                <p class="line-clamp-1">
                    ...
                    <a class="underline text-primary transition-colors hover:text-primary-focus dark:text-accent-light dark:hover:text-accent" href="pages-login-2.html">here</a>
                </p>
            </div>
        </div>
    </main>
