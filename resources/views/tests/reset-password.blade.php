...
<html lang="en">
    ...
    <!--begin::Head-->
    <head><base href="/vendor/qrfeedz-backend/"/>
            ...
            <div class="d-flex flex-column flex-column-fluid flex-lg-row">
                ...
                <div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
                    ...
                    <div class="d-flex flex-center flex-lg-start flex-column">
                        <!--begin::Logo-->
                        <a href="../../demo19/dist/index.html" class="mb-7">
                            <img alt="Logo" src="assets/media/logos/custom-3.svg" />
                        </a>
                        <!--end::Logo-->
                        <!--begin::Title-->
                        <h2 class="text-white fw-normal m-0">Feedback + AI. Success.</h2>
                        <!--end::Title-->
                    </div>
                    <!--begin::Aside-->
                </div>
                ...
                <div class="d-flex flex-column-fluid flex-lg-row-auto justify-content-center justify-content-lg-end p-12 p-lg-20">
                    ...
                    <div class="bg-body d-flex flex-column align-items-stretch flex-center rounded-4 w-md-600px p-20">
                        ...
                        <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                            <!--begin::Form-->
                            <form class="form w-100" novalidate="novalidate" id="kt_new_password_form" data-kt-redirect-url="../../demo19/dist/authentication/layouts/creative/sign-in.html" action="#">
                                <!--begin::Heading-->
                                <div class="text-center mb-10">
                                    ...
                                    <a href="../../demo19/dist/authentication/layouts/creative/sign-in.html" class="link-primary fw-bold">Sign in</a></div>
                                    <!--end::Link-->
                                </div>
                                <!--begin::Heading-->
                                <!--begin::Input group-->
                        ...
                        <div class="d-flex flex-stack px-lg-10">
                            ...
                            <div class="d-flex fw-semibold text-primary fs-base gap-5">
                                <a href="../../demo19/dist/pages/team.html" target="_blank">Terms</a>
                                <a href="../../demo19/dist/pages/pricing/column.html" target="_blank">Plans</a>
                                <a href="../../demo19/dist/pages/contact.html" target="_blank">Contact Us</a>
                            </div>
                            <!--end::Links-->
                        </div>
                        <!--end::Footer-->
